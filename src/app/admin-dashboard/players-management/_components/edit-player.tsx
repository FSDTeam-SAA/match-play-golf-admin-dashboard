...
//   // ✅ stop calling API when modal closed / no playerId / no token
//   const enabled = Boolean(open && playerId && token);
...
//       if (!res.ok || json?.success === false) {
//         throw new Error(json?.message || "Failed to load player");
//       }
...
//       // ✅ map exactly to your backend update body
//       const body =
//         values.entryType === "single"
//           ? {
//               userInfo: {
...
// import { SinglePlayerApiResponse } from "./single-player-data-type";
...
//   const {data} = useQuery<SinglePlayerApiResponse>({
//     queryKey: ["single-player", playerId],
//     queryFn: async ()=>{
//         const res = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/players/${playerId}`,{
//             method: "GET",
//             headers: {
//                 Authorization : `Bearer ${token}`
//             }
...
//         <div className="space-y-2">edit page {playerId}</div>
//       </DialogContent>
//     </Dialog>
//   );
// };
