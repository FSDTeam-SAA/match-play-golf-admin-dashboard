...
"[project]/src/app/(auth)/_components/verifyEmailPage.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const formSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].object({
    otp: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].string().min(6, {
...
const OtpForm = ()=>{
    ...
    const { mutateAsync, isPending } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        ...
        mutationFn: {
            "OtpForm.useMutation": async (payload)=>{
                const requestBody = email ? {
                    ...payload,
                    email
                } : payload;
                const res = await fetch("".concat(("TURBOPACK compile-time value", "http://localhost:5000/api"), "/auth/verify-code"), {
                    method: "POST",
                    headers: {
        ...
        onSuccess: {
            "OtpForm.useMutation": async (data)=>{
                ...
                if (email) {
                    ...
                    router.push("/reset-password?email=".concat(encodedEmail));
                } else {
        ...
        onError: {
            "OtpForm.useMutation": async (error)=>{
    ...
    async function onSubmit(payload) {
        try {
            ...
            console.error("OTP verification error: ".concat(error));
        }
    }
    const handleResendOTP = async ()=>{
        if (!email) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Email not found. Please go back to forgot password page.");
            return;
        }
        try {
            setLoading(true);
            ...
            const data = await res.json();
            if (!res.ok) {
                throw new Error((data === null || data === void 0 ? void 0 : data.message) || "Failed to resend OTP");
            }
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            fileName: "[project]/src/app/(auth)/_components/verifyEmailPage.tsx",
                            lineNumber: 143,
                            columnNumber: 26
                        }, ("TURBOPACK compile-time value", void 0))
                    ]
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            disabled: !email,
                            children: loading ? "Resend OTP..." : "Resend OTP"
                        }, void 0, false, {
                            fileName: "[project]/src/app/(auth)/_components/verifyEmailPage.tsx",
                            lineNumber: 192,
                            columnNumber: 11
...
_s(OtpForm, "gEH3WAgXpCOCXVaPMnXcdzp8RjA=", false, function() {
    return [
...
//# sourceMappingURL=src_9fb76835._.js.map