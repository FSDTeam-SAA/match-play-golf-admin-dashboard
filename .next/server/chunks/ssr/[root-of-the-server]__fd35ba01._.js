...
"[project]/src/app/(auth)/_components/resetPasswordPage.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const formSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].object({
    newPassword: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].string().min(6, {
        message: 'Password should be 6 character.'
    }),
    confirmPassword: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].string().min(1, {
...
const ResetPasswordForm = ()=>{
    ...
    const { mutateAsync, isPending } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        ...
        mutationFn: async (payload)=>{
            ...
            const res = await fetch(`${("TURBOPACK compile-time value", "http://localhost:5000/api")}/auth/reset-password`, {
                method: 'POST',
                headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fd35ba01._.js.map