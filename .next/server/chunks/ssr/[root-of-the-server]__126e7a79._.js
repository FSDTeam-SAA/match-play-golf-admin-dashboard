...
"[project]/src/app/(auth)/_components/verifyEmailPage.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const formSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].object({
    otp: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].string().min(6, {
...
const OtpForm = ()=>{
    ...
    const { mutateAsync, isPending } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        ...
        mutationFn: async (payload)=>{
            ...
            const res = await fetch(`${("TURBOPACK compile-time value", "http://localhost:5000/api")}/auth/verify-code`, {
                method: "POST",
                headers: {
    ...
    const handleResendOTP = async ()=>{
        if (!email) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Email not found. Please go back to forgot password page.");
            return;
        }
        try {
            setLoading(true);
            const res = await fetch(`${("TURBOPACK compile-time value", "http://localhost:5000/api")}/auth/forget-password`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__126e7a79._.js.map